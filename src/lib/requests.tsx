...
import { DebugTokenHeaders, FCC, RequestsContextValue, ResponseInfo } from './@types'
...
function hasProfilerHeaders(headers: Headers, tokenLinkHeader: string, tokenHeader: string) {
  return headers.has(tokenLinkHeader) && headers.has(tokenHeader)
}

export const RequestsProvider: FCC<DebugTokenHeaders> = ({ tokenHeader, tokenLinkHeader, children }) => {
